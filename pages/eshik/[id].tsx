...
import Eshikstyle1 from '@/component/derazaStyle/Eshikstyle1'
const id = (props: PageProps) => {
    ...
    const [EshikPalla, setEshikPalla] = useState<string>('1')

    switch (route.query.id) {
        case "1":
            page = <Eshikstyle1 shishaColor={props.ShishaColor} derazaColor={props.DerazaColor} seerazmer={'block'} />
            break;
    ...
    return (
        <>
            <div style={EshikPalla == '1' ? { width: '150px' } : { width: '350px' }} className={styles['DerazaGlavniExpanent']}>
                <div >
                    {page}
                </div>
                ...
                <div  >
                    <div style={EshikPalla == '1' ? { width: '150px' } : { width: '350px' }} className={styles['Razmerolishboyi']}>
                        <i className="fa-solid fa-chevron-left"></i>
                        <span></span>
                        <i className="fa-solid fa-chevron-right"></i>
                        <input placeholder='mm' />
            ...
            <div style={{ marginTop: '20px' }} className={styles['SliderDeraza']}>
                <div onClick={() => { route.push('/eshik/1'); setArkaBor(false) }}><Eshikstyle1 shishaColor={props.ShishaColor} derazaColor={props.DerazaColor} seerazmer={props.SeeRazmer} /></div>
            ...
            <div className={styles['rangi']}>
                <h1>Shisha Turi</h1>
                <div>
                    <Button class='BtnSucc' handelClick={() => { }} text='Gulsiz'></Button>
                    <Button class='' handelClick={() => { }} text='Gulli'></Button>
            ...
            <div className={styles['rangi']}>
                <h1>Room turi</h1>
                <div>
                    <Button class='BtnSucc' handelClick={() => { }} text='Metall'></Button>
                    <Button class='' handelClick={() => { }} text='Plasmass'></Button>
